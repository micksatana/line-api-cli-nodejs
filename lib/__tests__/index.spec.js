...
test('index provides access to API classes', () => {
  ...
  expect(apis.LINETvGetCategoryRequest).toBeDefined();
  expect(apis.LINETvGetSpotlightRequest).toBeDefined();
  expect(apis.LINETvListCategoryRequest).toBeDefined();
  expect(apis.LINETvListModulesRequest).toBeDefined();
  expect(apis.LINETvRequest).toBeDefined();
