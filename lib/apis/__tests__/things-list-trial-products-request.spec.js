...
import ThingsListTrialProductsRequest from '../things-list-trial-products-request';

describe('ThingsListTrialProductsRequest', () => {
  describe('when create an instance with options.accessToken', () => {
    ...
    beforeAll(() => {
      ...
      req = new ThingsListTrialProductsRequest({ accessToken });
    });
