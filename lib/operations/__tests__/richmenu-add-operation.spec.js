    ...
    describe('prompts for data file path', () => {
      ...
      describe('and user cancel', () => {
        ...
        it('call onCancel', async () => {
          await expect(
            RichmenuAddOperation.run().catch(_ => {})
          ).resolves.toEqual();
      ...
      describe('and user input correct data file path', () => {
        describe('prompts for image file path', () => {
          ...
          const dataFilePath = 'some/data/file/path';
          ...
          describe('and user cancel', () => {
            beforeAll(() => {
              ...
              spyOn(path, 'isAbsolute').mockReturnValue(false);
              spyOn(path, 'resolve').mockReturnValue('./some/data/file/path');
            });

            it('call onCancel', async () => {
              await expect(RichmenuAddOperation.run().catch(_ => {})).resolves.toEqual();
              ...
              expect(path.isAbsolute).toHaveBeenCalledWith(dataFilePath);
              expect(path.resolve).toHaveBeenCalledWith('./', dataFilePath);
            });
            ...
            describe('when successfully add rich menu', () => {
              ...
              describe('and failed to upload rich menu', () => {
                ...
                it('handles error', async () => {
                  ...
                  expect(console.log).toHaveBeenCalledWith(
                    `Rich menu ID: ${richMenuId.code}`.success
                  );
                  expect(
              ...
              describe('and successfully upload rich menu', () => {
                ...
                it('return true', async () => {
                  ...
                  expect(console.log).toHaveBeenCalledWith(
                    `Rich menu image uploaded`.success
                  );
