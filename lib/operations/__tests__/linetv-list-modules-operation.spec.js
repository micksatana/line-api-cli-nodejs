  ...
  describe('when config is valid', () => {
    ...
    describe('when failed to list curation', () => {
      ...
      it('handles error', async () => {
        await expect(LINETvListModulesOperation.run({})).resolves.toEqual(
          false
        );
    ...
    describe('when has curation module', () => {
      const mockResponse = {
        data: {
          body: {
            supportModule: [
      ...
      beforeAll(() => {
        spyOn(LINETvListModulesOperation.request, 'send').mockResolvedValueOnce(
          mockResponse
        );
      });
    ...
    describe('when input options --format json', () => {
      ...
      beforeAll(() => {
        spyOn(LINETvListModulesOperation.request, 'send')
      ...
      it('display data correctly', async () => {
        await expect(
          LINETvListModulesOperation.run({ format: 'json' })
